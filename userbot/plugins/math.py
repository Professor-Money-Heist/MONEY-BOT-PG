...
# KEEP CREDIT
# MADE FOR MONEY-HEIST-BOT
# BY TEAM MONEY-HEIST-BOT
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="sin ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="cos ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="tan ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="cosec ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="sec ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="cot ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="square ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@MONEY_HEIST_BOT.on(admin_cmd(pattern="cube ?(.*)"))
@MONEY_HEIST_BOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))

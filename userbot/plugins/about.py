...
pm_caption += f"┣𝙼𝙾𝙽𝙴𝚈 𝙷𝙴𝙸𝚂𝚃 ~ {LEGENDversion}\n"
pm_caption += f"┣𝙿𝚁𝙾𝙵𝙴𝚂𝚂𝙾𝚁  ~ [𝙲𝚁𝙴𝙰𝚃𝙾𝚁](https://t.me/Prof_Agora)\n"
pm_caption += f"┣𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ~ [𝙶𝚁𝙾𝚄𝙿](https://t.me/MM_USERBOT)\n"
pm_caption += f"┣𝚁𝙴𝙿𝙾    ~ [𝚁𝙴𝙿𝙾](https://github.com/Professor-Money-Heist/MONEY-HEIST-BOT)\n"
pm_caption += f"**╰────────────**\n"
